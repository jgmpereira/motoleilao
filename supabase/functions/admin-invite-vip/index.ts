...
<body style="margin:0;padding:0;background:#f0f2f5;font-family:'Helvetica Neue',Arial,sans-serif;">
        ...
        <tr>
          <td style="padding:36px 40px 28px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td align="center">
                  <a href="https://xn--moteleio-xza.com.br" style="display:inline-block;background:#ff4d00;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;letter-spacing:.5px;padding:14px 36px;border-radius:8px;">Acessar o MotoLeilão →</a>
                </td>
              </tr>
            </table>
  ...
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'MotoLeilão <contato@xn--moteleio-xza.com.br>',
      to: [email],
